...
#define CSMA_EAU_MAISON_LV1 20
#define CSMA_ELEC_MAISON_LV1 20
...
#define CSMA_EAU_CENTRALE_LV1 0
#define PRODU_ELEC_CENTRALE_LV1 50

#define PRODU_EAU_CHATEAU_LV1 50
#define CSMA_ELEC_CHATEAU_LV1 0
